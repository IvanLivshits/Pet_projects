const interestingFactRus = [
    "Предположительно тёмная материя составляет 25%, тёмная энергия 70%, а барионная (обычная) материя всего 5% всей массы нашей вселенной",
    "Солнце может вместить в себя около миллиона таких планет как Земля",
    "Меркурий вращается быстрее вокруг Солнца, чем Плутон",
    "В некоторых местах на Венере можно попасть под свинцовый свет",
    "До Плутона лететь с Земли почти 800 лет",
    "На Луне не хватает атмосферы, но есть замороженная вода под поверхностью",
    "Во Вселенной больше звёзд, чем всех песчинок на Земле",
    "Первое фото черной дыры получено 10 апреля 2019 года. Международный проект представил первый снимок в истории горизонта событий чёрной дыры",
    "Тёмная материя удерживает галактики вместе, хотя и невидима для нашего глаза",
    "На Земле всегда видно только одну сторону Луны",
    "На Марсе синий закат, а не жёлтый как на Земле",
    "Каждый год 12 апреля весь мир отмечает Международный день полёта в космос",
    "Если Солнце станет ещё ярче, то океаны на Земле закипят",
    "Вимпы - элементарные частицы, претендующие на роль составляющих тёмной материи",
    "Химический состав Марса позволяет предположить, что там могли сформировать жизнь (микроорганизмы)",
    "Существование гравитационных волн предсказал Эйнштейн, но обнаружить их удалось только спустя 100 лет",
    "В некоторых галактиках не образуются звёзды из - за сверхмассивных чёрных дыр",
...
while (interestingFactRus[i]) {
    counterRus++
    i++;
}

export { interestingFactRus, counterRus }